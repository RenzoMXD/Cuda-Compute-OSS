...
| Pin | Value |
|---|---|
| **GPU** | One fixed evaluation device (reference: NVIDIA A100 80 GB), same physical class for every eval; clocks recorded per run |
...
A public **dashboard** (static page fed by `dashboard/data.json`) renders the
